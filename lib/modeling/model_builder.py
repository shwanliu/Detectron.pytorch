...
class Generalized_RCNN(nn.Module):
    ...
    def _forward(self, data, im_info, roidb=None, **rpn_kwargs):
        ...
        if self.training:
            ...
            # bbox loss
            loss_cls, loss_bbox, accuracy_cls, bbox_sl1, bbox_iou, bbox_giou,bbox_logGiou = fast_rcnn_heads.fast_rcnn_losses(
            ...
            return_dict['metrics']['bbox_logGiou'] = bbox_logGiou
